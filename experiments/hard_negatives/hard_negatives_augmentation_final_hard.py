...
for lower_bound in lower_bounds:
    for upper_bound in upper_bounds:
        ...
        quota = n_negatives + n_negatives_val #85% + 15% initial dataset
        ...
        path_train_augmented = path_threshold / f"train_final_augmented_hard.pickle"
        with open(path_train_augmented, "wb") as f:
            pickle.dump(resized_data, f)
        path_val_augmented = path_threshold / f"val_final_augmented_hard.pickle"
